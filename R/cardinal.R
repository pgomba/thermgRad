...
cardinal<-function(data="template dataframe",
  ...
  temp<-tempgrad(dayBL,dayBR,dayTL,dayTR,nightBL,nightBR,nightTL,nightTR,petri,method,adjust)
  ...
  show(ggplot(grid_temp,aes(x=average,y=GR,colour=cardinal_labels))+
